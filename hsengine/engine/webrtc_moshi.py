...
SPOKEN_SYSTEM = (
    ...
    "do not have — call web_search. After a pause, interruption, silence, or "
    "whenever you have lost the thread of this meeting — call narrative: it "
    "returns the slide that belongs at this minute of the call. Speak from "
    "there. After a search, if you were presenting, call narrative then resume. "
    "Do not ask "
